...
// Komponen ini HANYA dimount saat paletteOpen === true — pembungkusnya
// (CommandPalette.tsx) yang menjaga itu lewat satu langganan boolean, supaya
// hook & state di bawah (termasuk langganan store penuh ini) tidak pernah
// hidup saat command palette tertutup.
export default function CommandPaletteInner() {
  ...
  // Komponen ini mount tepat saat dibuka dan unmount tepat saat ditutup (lihat
  // CommandPalette.tsx), jadi "reset saat dibuka" = "jalankan sekali saat
  // mount", dan "kembalikan fokus saat ditutup" = cleanup unmount biasa —
  // sama persis efeknya dengan effect lama yang bercabang pada paletteOpen.
  useEffect(() => {
